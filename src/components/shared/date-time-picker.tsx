        ...
        <DayPicker
            ...
            classNames={{
                ...
                button_previous: cn(
                    ...
                    'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-5 top-4',
                ...
                MonthCaption: ({ calendarMonth }) => {
                    return (
                        <div className="inline-flex gap-2">
                            ...
                            >
                                <SelectTrigger className="w-fit gap-1 border-none outline-none shadow-none p-0 focus:bg-accent focus:text-accent-foreground">
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                                    {MONTHS.map((month) => (
