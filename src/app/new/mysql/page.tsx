...
const generateScheduledDeployAt = (extraSeconds: number = 0): string => {
    const now = new Date();
...
const SCHEDULE_OFFSET = 7 * 60 * 60 * 1000;
...
const CreateMySQL = () => {
    ...
    const onSubmit: SubmitHandler<ApplicationFormValues> = async (data) => {
        data.scheduled_deploy_at = isScheduleEnabled
            ? new Date(data.scheduled_deploy_at + SCHEDULE_OFFSET).toISOString()
                    ...
                    <div className="grid grid-cols-1 gap-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 items-center">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">The MySQL version</p>
                            </div>
                            <Select
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 items-center">
                            ...
                            <div>
                                <DateTimePicker
                                    ...
                                    onChange={(value) => {
                                        setDate(value);
                                        setValue("scheduled_deploy_at", value?.toISOString() || "");
                                    }}
                                    className="w-[280px]"
